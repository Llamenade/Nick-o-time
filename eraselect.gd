...
func _process(delta: float) -> void:
	...
	if Global.is_trex_level or Global.is_mosasaurus_level or Global.is_pterodactyl_level or Global.is_smilodon_level or Global.is_woolymammoth_level or Global.is_abominablesnowman_level:
